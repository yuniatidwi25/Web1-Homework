<?php
    ...
    $sqlupdate = mysqli_query($con, "UPDATE akun SET subscribe = 0 WHERE username = '$username'");
    
    if($sqlupdate === TRUE){
        echo "<script>alert('So sad, you unsubscribe us')</script>";
    }
    else
    {
        echo "<script>alert('unsubscribe failed')</script>";
    }
